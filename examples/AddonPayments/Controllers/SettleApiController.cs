...
namespace AddonPayments.Controllers
{
    [ApiController]
    [Route("[Controller]")]
    public class SettleApiController : ControllerBase
    {
        [HttpPost]
        public IActionResult SettleApi(Datos detalles) {
            ...
            try {
                ...
                Transaction response = capture.Capture(detalles.Tarjeta.importe)
                        .WithCurrency("EUR")
                        .Execute();
