...
namespace AddonPayments.Controllers
{
    [ApiController]
    [Route("[Controller]")]
    public class FraudreleaseApiController : ControllerBase
    {
        [HttpPost]
        public IActionResult FraudreleaseApi(Datos detalles) {
            ...
            try {
                ...
                Respuesta respuesta = new Respuesta { result = result, message = message, orderId = order, authCode = authCode, paymentsReference = paymentsRef, schemeReferenceData = schemeReferenceData};
